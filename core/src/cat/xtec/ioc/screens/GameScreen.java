...
public class GameScreen implements Screen {
    ...
    private Container containerPuntuacion;
    // Objectes necessaris
    private Stage stage;
    private Spacecraft spacecraft;
    private ScrollHandler scrollHandler;
    private Label puntuacionDisplay;
    ...
    public GameScreen(Batch prevBatch, Viewport prevViewport) {
        ...
        puntuacionDisplay = new Label("Points: " + puntosTotales, textStyle);
        // Afegim els actors a l'stage

        containerPuntuacion = new Container(puntuacionDisplay);
        containerPuntuacion.setTransform(true);
        containerPuntuacion.center();
        containerPuntuacion.setPosition(50,20);
        ...
        stage.addActor(containerPuntuacion);
        currentState = GameState.READY;

        // Assignem com a gestor d'entrada la classe InputHandler
        Gdx.input.setInputProcessor(new InputHandler(this));
        arrayGroup = stage.getActors();
    ...
    private void updateRunning(float delta) {
        stage.act(delta);
        puntuacionDisplay.setText("Points: "+puntosTotales);
